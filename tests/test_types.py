...
class TestTypes(unittest.TestCase):
    ...
    def test_reconstruction(self):
        # Multi camera setup
        micasa_redsense_files = [
            ("IMG_0298_1.tif", "Red", 1),
            ("IMG_0298_2.tif", "Green", 2),
            ("IMG_0298_3.tif", "Blue", 3),
            ("IMG_0298_4.tif", "NIR", 4),
            ("IMG_0298_5.tif", "Rededge", 5),
            ("IMG_0299_1.tif", "Red", 1),
            ("IMG_0299_2.tif", "Green", 2),
            ("IMG_0299_3.tif", "Blue", 3),
            ("IMG_0299_4.tif", "NIR", 4),
            ("IMG_0299_5.tif", "Rededge", 5),
            ("IMG_0300_1.tif", "Red", 1),
            ("IMG_0300_2.tif", "Green", 2),
            ("IMG_0300_3.tif", "Blue", 3),
            ("IMG_0300_4.tif", "NIR", 4),
            ("IMG_0300_5.tif", "Rededge", 5),
        ]
        ...
        self.assertTrue(
            [p.filename for p in recon.multi_camera[0]["photos"]]
            == ["IMG_0298_1.tif", "IMG_0299_1.tif", "IMG_0300_1.tif"]
        )
